...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if ($result->num_rows == 1) {
        ...
        if ($password === $admin['password']) {
            ...
            $_SESSION['manager_username'] = $admin['username'];
            $_SESSION['manager_email'] = $admin['email'];
            $_SESSION['is_manager_logged_in'] = true; // ตั้งค่าให้ระบุว่าผู้ใช้เข้าสู่ระบบแล้ว
...
<head>
    ...
    <title>เข้าสู่ระบบ (manager)</title>
</head>
<body>
    <h1>เข้าสู่ระบบ (manager)</h1>
